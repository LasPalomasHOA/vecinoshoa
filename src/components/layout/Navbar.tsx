...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-30 h-14 bg-white/95 backdrop-blur-md px-6 flex items-center justify-between gap-4 border-b border-slate-200/80 shadow-xs no-print print:hidden">
      
      {/* Breadcrumbs & Active Title with stable fixed-width container */}
